<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Manage_Vendor.aspx.cs" Inherits="_Default" %>
  ...
  <section id="page-banner" class="page-banner" style="background-image: url('images/banner.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Manage Vendors</h2>
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            <li><a href="index.html">Admin Index</a></li>
        ...
        <table>
          <tr class="top-heading-row" style="align-text:center">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr>
                        <td class="vendor-img"><asp:Image ID="Image1" runat="server" width="167" class="img-responsive" alt="vendor-img" ImageUrl='<%# DataBinder.Eval(Container,"DataItem.upload_pic") %>' Height="147" /></td>
