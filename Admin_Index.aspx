<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Admin_Index.aspx.cs" Inherits="_Default" %>
  ...
  <section id="page-banner" class="page-banner bg-dark" style="background-image: url('images/banner-2.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Admin Dashboard</h2>
  ...
  <section id="vendor-dashboard" class="vendor-dashboard-main-block">
    <div class="container">
      <ul class="vendor-dashboard-tabs general-nav-tabs tabs">
        ...
        <li><a href="Manage_Orders.aspx" class="btn btn-default"><span class="badge">Orders</span></a></li>
        <li><a href="Answer_Queries.aspx" class="btn btn-default"><span class="badge">Queries</span></a></li>
        <li><a href="Manage_Vendor.aspx" class="btn btn-default"><span class="badge">Vendors</span></a></li>
        <li><a href="Manage_Customer.aspx" class="btn btn-default"><span class="badge">Customers</span></a></li>
        <li><a href="Add_Admin.aspx" class="btn btn-default"><span class="badge">Admin</span></a></li>
      </ul>
