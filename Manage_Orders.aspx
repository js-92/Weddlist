<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Manage_Orders.aspx.cs" Inherits="_Default" %>
...
<!-- end page banner -->
    ...
    <div class="container">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" BackColor="White"  CellPadding="5" style="border:1px solid black;border-radius:4px;padding:5%;text-align:center" GridLines="Both" CellSpacing="3" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" HeaderStyle-Wrap="False">
            <Columns>
                ...
                <asp:BoundField DataField="vendor_email" HeaderText="Vendor Detail" SortExpression="vendor_email"></asp:BoundField>
            ...
            <HeaderStyle BackColor="#FF4061" Font-Bold="True" ForeColor="White" Font-Strikeout="False" Font-Underline="False" BorderWidth="1" BorderStyle="None" HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
