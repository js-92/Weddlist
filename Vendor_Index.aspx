<%@ Page Title="" Language="C#" MasterPageFile="~/VendorMasterPage.master" AutoEventWireup="true" CodeFile="Vendor_Index.aspx.cs" Inherits="_Default" %>
  ...
  <section id="page-banner" class="page-banner bg-dark" style="background-image: url('images/banner-2.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Vendor Dashboard</h2>
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            <li><a href="Vendor_Index.aspx">Home</a></li>
  ...
  <section id="vendor-dashboard" class="vendor-dashboard-main-block">
    <div class="container">
      <ul class="vendor-dashboard-tabs general-nav-tabs tabs">
        ...
        <li><a href="Pending_Order.aspx" class="btn btn-default"><span class="badge">Pending Orders</span></a></li>
        <li><a href="All_Orders.aspx" class="btn btn-default"><span class="badge">All Orders</span></a></li>
        <li><a href="Vendor_Profile.aspx" class="btn btn-default"><span class="badge">Your Profile</span></a></li>
      </ul>
