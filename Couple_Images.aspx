<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Couple_Images.aspx.cs" Inherits="_Default" %>
  ...
  <section id="page-banner" class="page-banner" style="background-image: url('images/banner.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Couple Images</h2>
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            <li><a href="Index.aspx">Home</a></li>
            <li class="active">Couple Images</li>
          </ol>
        </div>
      </div>
    </div>
