<%@ Page Title="" Language="C#" MasterPageFile="~/VendorMasterPage.master" AutoEventWireup="true" CodeFile="Edit_Vendor_Profile.aspx.cs" Inherits="_Default" %>
  ...
  <section id="page-banner" class="page-banner" style="background-image: url('images/banner.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Edit Vendor</h2>
