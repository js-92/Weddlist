<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Edit_Customer_Detail.aspx.cs" Inherits="_Default" %>
  ...
  <section id="page-banner" class="page-banner" style="background-image: url('images/banner.jpg');"> 
    ...
    <div class="container">
      <div class="banner-dtl text-center">
        <h2 class="banner-heading">Edit Customer</h2>
        <div class="breadcrumb-block">
          <ol class="breadcrumb">
            <li><a href="Admin_Index.aspx">Home</a></li>
            ...
            <div class="couple-profile-block mrgn-bottom-30">
              <h3 class="couple-profile-heading">Customer Profile</h3>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8"><asp:Label ID="Label1" runat="server" Text="" class="form-control"></asp:Label></div> 
                  </div>
                         </ContentTemplate>
                    </asp:UpdatePanel>
                    <div class="form-group row">
                    ...
                    <div class="col-sm-8"><asp:TextBox ID="TextBox9" runat="server" class="form-control"></asp:TextBox></div> 
                     ...
                     <div class="form-group row">
                        <div class="col-sm-offset-4 col-sm-8"><asp:Button ID="Button1" runat="server" Text="Edit" class="btn btn-pink" style="height:50px;width:150px" OnClick="Button1_Click"/></div> 
                  </div>
            </div>
          </div>
        </div>
