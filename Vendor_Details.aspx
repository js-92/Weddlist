<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Vendor_Details.aspx.cs" Inherits="_Default" %>
...
<!-- vendor profile -->
  ...
  <button type="button"  data-toggle="modal" data-target="#login-model" class="btn btn-pink" style="height:50px;width:100px;">Delete</button>
    <asp:Button ID="Button2" runat="server" Text="Edit" class="btn btn-pink" style="height:50px;width:100px;" OnClick="Button2_Clicked" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.Id") %>' />
<!-- login popup -->
            ...
            <div class="modal-body login-model-body text-center">
              <form id="login-form" action="#">
                <div class="form-group">
                    <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="Admin Id" ></asp:TextBox>
                    <asp:TextBox ID="TextBox2" runat="server" class="form-control" placeholder="Admin Password" ></asp:TextBox>
                </div>
                  <asp:Button ID="Button1" runat="server" Text="Delete" OnClick="Button1_Clicked" class="btn btn-pink" />
              </form>
            </div>            
          </div>
        </div>
